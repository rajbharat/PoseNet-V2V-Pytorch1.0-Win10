...
def parse_args():
    ...
    parser.add_argument('--resume', '-r', default=2, type=int, help='resume after epoch')
...
data_dir = r'D:\Bharat-DONOTDELETE\Core\V2V-PoseNet-pytorch-master\V2V-PoseNet-pytorch\to\msra-hand'
center_dir = r'D:\Bharat-DONOTDELETE\Core\V2V-PoseNet-pytorch-master\V2V-PoseNet-pytorch\to\msra-hand-center'
keypoints_num = 21
test_subject_id = 3
cubic_size = 200
